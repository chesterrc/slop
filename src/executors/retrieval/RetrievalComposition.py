...
# import asyncio
#
# from src.db.vectorEmbedding import VectorRetrievalRepository
# from app.repositories.base import RetrievalRepositoryInterface
...
#         self._retrieval_repo: RetrievalRepositoryInterface | None = None
...
#
#     async def get_retrieval_repository(self) -> RetrievalRepositoryInterface:
#         if self._retrieval_repo is None:
#             client = await self.get_vector_client()
#             self._retrieval_repo = VectorRetrievalRepository(client=client)
